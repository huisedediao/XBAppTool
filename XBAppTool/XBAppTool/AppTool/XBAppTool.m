...
#pragma mark - 点击tableView的时候隐藏键盘
/**
...
{
    UITapGestureRecognizer *gestureRecognizer = [[UITapGestureRecognizer alloc] initWithTarget:target action:@selector(hideKeyboardFun)];
